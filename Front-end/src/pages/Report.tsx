...
import { List, InputItem, Picker, WhiteSpace, Button } from 'antd-mobile';
...
export default function ReportPage() {
  ...
  const { reportInfo: editedInfo, setReportInfo, setViolationType, setPlateNumber, onSubmit } = useModel('report-editor');
  ...
  return (
    <div>
      <List>
        ...
        <WhiteSpace size="lg" /> 
        <List>       
          <InputItem placeholder="Input the plate number." value={editedInfo?.plate_num} onChange={onPlateNumberChange}>车牌号</InputItem>
        <Picker data={violationPickerData} cols={1} value={[editedInfo?.violation_type || ""]} onChange={onViolationChange}>
          <Item>违章类型</Item>
        </Picker>
      </List>
